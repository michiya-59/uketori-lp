...
export const REASONS: Reason[] = [
  ...
  },
  {
    ...
    title: "AIが銀行明細と請求を照合\n消込を90%自動化",
    description:
      "銀行明細のCSV取込やPDF・画像のOCR読取で入金データを簡単に取得。AIが請求書と照合し、消込候補を提示します。ワンクリックで確定するだけで消込完了です。",
    icon: "Zap",
    bullets: [
      "主要銀行のCSV明細をドラッグ＆ドロップで取込",
...
export const STEPS: Step[] = [
  ...
  },
  {
    ...
    title: "データ取込・初期設定",
    description:
      "既存のExcelデータをアップロード。銀行明細の取込設定もガイドに沿って簡単に完了します。",
    icon: "Settings",
  },
  {
    number: 3,
...
export const FAQ_ITEMS: FAQItem[] = [
  ...
  {
    question: "銀行明細の取込はどの銀行に対応していますか？",
    answer:
      "主要メガバンク（三菱UFJ、三井住友、みずほ、楽天銀行）のCSV明細取込に対応しています。また、AI-OCR機能でPDFや画像の銀行明細も読み取り可能です。対応銀行は順次拡大中です。",
  },
  {
    question: "セキュリティ対策はどうなっていますか？",
    answer:
      "SSL/TLS暗号化通信、データの暗号化保存、二要素認証、IPアドレス制限など、堅牢なセキュリティ対策を実施しています。すべての操作は監査ログに記録され、安心してご利用いただけます。",
  },
  {
    question: "他の会計ソフトとの連携はできますか？",
    answer:
      "freee会計、マネーフォワードクラウド、弥生会計など主要な会計ソフトからのCSVデータ取込に対応しています。既存データをスムーズに移行でき、導入時の手間を大幅に削減します。",
  },
  {
